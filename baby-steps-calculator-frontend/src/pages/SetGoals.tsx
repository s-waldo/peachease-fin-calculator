...
export default function SetGoals() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setGoals(
      e.target.name as keyof GoalsData,
  ...
  return (
    <FormBlock>
      <h3>Set Goals</h3>
      <FormFieldset>
        <FormLabel htmlFor="targetEmergencyFund">
          Target Emergency Fund
        </FormLabel>
        <FormatDecimalNumberInput
          name="targetEmergencyFund"
          id="targetEmergencyFund"
          value={goals.targetEmergencyFund}
      ...
      <FormFieldset>
        ...
        <FormatDecimalNumberInput
          name="targetRetirementBalance"
          id="targetRetirementBalance"
          value={goals.targetRetirementBalance}
          onChange={handleChange}
        />
      </FormFieldset>
      <FormFieldset>
